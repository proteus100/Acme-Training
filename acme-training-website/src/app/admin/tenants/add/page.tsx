            ...
            <button
              ...
              onClick={() => {
                ...
                if (formData.businessType && formData.city) {
                  ...
                  handleInputChange('metaTitle', `${businessName} - ${formData.businessType} in ${location}`)
                  handleInputChange('metaDescription', `Professional ${type} courses in ${location}. Expert instructors, flexible booking, industry-leading certification. Book your training today.`)
                  handleInputChange('heroHeading', `Professional ${formData.businessType} in ${location}`)
                  handleInputChange('heroSubheading', `Expert training courses with flexible booking and industry-leading certification`)
                }
              }}
