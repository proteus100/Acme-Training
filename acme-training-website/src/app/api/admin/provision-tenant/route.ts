...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      urls: {
        adminDashboard: `${process.env.NEXT_PUBLIC_BASE_URL}/${tenant.slug}/admin`,
        publicSite: `${process.env.NEXT_PUBLIC_BASE_URL}/${tenant.slug}`,
        coursesManagement: `${process.env.NEXT_PUBLIC_BASE_URL}/${tenant.slug}/admin/courses`
      }
    })
